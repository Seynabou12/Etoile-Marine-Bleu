        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 mt-4  home">
                    ...
                    <span class="mt-3 home_title">
                        @lang('home.title')
                    </span>
                    {{-- @include('langue') --}}
                    @if(Auth::check())
                    <br>
                        <a href="{{ route('admin.dashboard') }}"> {{ __('home.mySpace') }}</a>
                    @endif
                </div>
            </div>
            <div class="row p-4 align-items-center" style="height: calc(100vh - (100px))">
                <div class="col-6">
                    <h3 class="h1">
                        UN OBJET PERDU SE TRANSFORME SOUVENT EN OBJET TROUVÉ !
                    </h3>
                    <h5>
                        Vous avez perdu ou trouvé un objet ?
                        <br>
                        Déclarez-le et la communauté se mobilise pour vous aider à le retrouver.
                    </h5>
                    <div class="d-flex justify-content-between align-items-center mt-4">
                        <button class="btn btn-primary btn-style">J'ai perdu </button>
                        <button class="btn btn-primary btn-style">J'ai retrouvé </button>
                    </div>
                </div>
            </div>
        </div>
