...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="container-fluid">
            <div class="row">
                @include('partials.theme.nav-horizontal')
            </div>
            @include('partials.theme.sections.section-1')
            @include('partials.theme.sections.section-2')
            @include('partials.theme.sections.section-3')
            @include('partials.theme.sections.section-4')
            @include('partials.theme.sections.section-5')
            @include('partials.theme.sections.footer')
        </div>
