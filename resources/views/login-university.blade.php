        ...
        <div class="col-lg-6 connexion col-12 min-vh-100 p-4 d-flex justify-content-center" style="flex-direction: column;">
            ...
            <div class="connexion_contenu">
                <form method="POST" action="{{ route('login') }}" class="form">
                    @csrf
                    <h2 class="mt-4">@lang('auth.connexion')</h2>
                    <div class="mt-3 group connexion_contenu_form">
                        <label for="email" class="label">identifiant ou email*</label>
                    ...
                    <div class="mt-3 group-submit d-flex justify-content-between align-items-center">
                        <div class="submit">
                            <button class="btn btn-primary radius-10 pl-4 pr-4" style="padding: 10px" type="submit" >Connexion</button>
                        </div>
                        <div class="redirect-register">
                            <a href="{{ url('/') }}"><span class ="text-primary"> <u>Home</u> </a>
                        </div>
                    </div>
                </form>
            </div>
        </div>
        <div class="col-lg-6 col-12 d-sm-block d-none" style="background: url({{ asset('img/university.png') }}); background-size:cover; background-size: 100% 100%;background-repeat: no-repeat;">
        </div>
    </div>
</div>
<!-- <div class="ccontainer container-login ">
    <div class="row">
        <div class="form-login col-12 col-sm-6 col-lg-6">
            <div class="form-img-logo">
                <img src="{{ asset('img/Vector2.png')}}"  alt= "login" >
                <img class="my-revo" src="{{ asset('img/MyPathway2.png') }}"  alt= "logo">
            </div>
            <form method="POST" action="{{ route('login') }}" class="form">
                @csrf
                <h2>Connexion</h2>
                ...
                <div class="group-submit">
                    ...
                    <div class="redirect-register">
                        <a href="{{ route('register') }}"><span class =" dark"> Not yet an account</span>Register ?</a>
                    </div>
                </div>
            </form>
        </div>
        <div class="container-login-img col-12 col-sm-6 col-lg-6" >
